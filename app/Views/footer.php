<footer>
    ...
    <nav>
        <h2>Adote</h2>
        <div class="menu">
            <a href="<?= URL.'/page/adotar' ?>">Adote com responsabilidade</a>
    ...
    <nav>
        <h2>Colabore</h2>
        <div class="menu">
            <a href="<?= URL.'/page/colabore' ?>">Doe qualquer valor</a>
            <a href="#">Faça parte do Clube do Amigo</a>
            <a href="#">Compre nas Lojas Parceiras</a>
        </div>
    </nav>
    <nav>
        ...
        <div class="menu">
            ...
            <div class="redes-sociais">
                ...
                <a href="<?= WHATSAPP ?>" target="_blanck" >
